...
public class scrapowanie {
    ...
    public static  void ScrapowanieWindSpeed(){
        driver.navigate().to("https://www.wunderground.com/history/monthly/us/mi/detroit/KDET/date/2023-2");
        List<WebElement> temperatureElements = driver.findElements(By.xpath("//*[@id=\"inner-content\"]/div[2]/div[1]/div[5]/div[1]/div/lib-city-history-observation/div/div[2]/table/tbody/tr/td[5]/table/tr/td[2]"));

        String csv_file_path = "src/main/windspeed.csv";
    ...
    public  static void ScrapowaniePressure(){
        driver.navigate().to("https://www.wunderground.com/history/monthly/us/mi/detroit/KDET/date/2023-2");
        List<WebElement> temperatureElements = driver.findElements(By.xpath("//*[@id=\"inner-content\"]/div[2]/div[1]/div[5]/div[1]/div/lib-city-history-observation/div/div[2]/table/tbody/tr/td[6]/table/tr/td[2]"));

        String csv_file_path = "src/main/pressure.csv";
